...
@Component({ selector: 'app-membership-admin', imports: [CurrencyPipe, ReactiveFormsModule, MembershipPaymentHistory], styleUrl: './membership.scss', template: `
